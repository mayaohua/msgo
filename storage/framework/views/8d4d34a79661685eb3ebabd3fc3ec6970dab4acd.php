...
<div id="container">
    <div style="">
        <?php echo $__env->make('wx.card.swipe', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
    </div>
    ...
    <div style="margin:10px 5px;">
        <van-grid>
            <van-grid-item @click="gotoPage(value.href)" :border="false"   v-for="(value,index) in gridArr" :key="index">
                ...
                <span class="van-grid-item__text">{{value.name}}</span>
            </van-grid-item>
        </van-grid>
    </div>
    <div>
                        ...
                        <div class="prick-items">
                            <van-cell v-for="(item1,index1) in item.cards" :key="index1">
                                <div class="prick-item" @click="gotoPage('/card/details/'+item.id+'?card_id='+item1.id)">
                                    <img :src="lt_img_domain+item.case_icon" alt="">
        ...
        <div class="list" style="border-radius: 5px;">
            ...
            <div class="jinpin-items" v-if="!first" >
                <div class="jinpin-item" v-for="item in bestNums"  @click="gotoOrder(item)">
                    <img :src="lt_img_domain+item.card_icon" alt="">
    ...
    new Vue({
        ...
        data:{
            ...
            gridArr:[
                {
                    name:'精品靓号',
                    src:"<?php echo URL::asset('images/002_jinpin.png'); ?>",
                    href:"/card/bestnum/"
                },
                {
                    name:'卡种选购',
                    src:"<?php echo URL::asset('images/002_fenlei.png'); ?>",
                    href:"/card/kind"
                },
                {
                    name:'靓号扫描',
                    src:"<?php echo URL::asset('images/002_setting.png'); ?>",
                    href:"/card/wxapp"
                },
                {
                    name:'订单查询',
                    src:"<?php echo URL::asset('images/order.png'); ?>",
                    href:"https://m.10010.com/mfront/views/my-order/main.html#/orderlist?oneKey=t&refresh_sign=1&from=tx"
                },
                {
                    name:'QQ群聊',
                    src:"<?php echo URL::asset('images/help.png'); ?>",
                    href:"/card/qq"
                },
                {
                    name:'话费充值',
                    src:"<?php echo URL::asset('images/002_file.png'); ?>",
                    href:"/bill/"
                },
                {
                    name:'问题反馈',
                    src:"<?php echo URL::asset('images/jl.png'); ?>",
                    href:"/card/question"
                },
                {
                    name:'联系我们',
                    src:"<?php echo URL::asset('images/002_me.png'); ?>",
                    href:"/card/us"
                }
            ],
            first : true,
            hotCards: <?php echo $hot_cards; ?>,
