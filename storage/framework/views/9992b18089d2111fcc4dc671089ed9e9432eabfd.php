...
<div id="container">
    <div class="user-top">
        ...
        <mt-field placeholder="请输入提现金额(不低于2元)" type="number" v-model="tixian_price">
        </mt-field>
        <mt-cell title="收款码">
    ...
    <div class="wenti" style="margin:10px">
        ...
        <p>4.如有疑问，请联系客服</p>
        <p>5.如需要更改绑定的微信号或手机号，请联系微信客服（微信号：mm_yidu）。</p>
    </div>
</div>
<?php $__env->stopSection(); ?>
...
<script type="text/javascript">
    new Vue({
        el:"#app",
        data:{
            user_pic: "<?php echo e($user_pic); ?>",
            user_name: "<?php echo e($user_name); ?>",
            user_phone: "<?php echo e($user_phone); ?>",
        ...
        methods: {
           ...
           tixian:function(){
               if(parseFloat(this.tixian_price) < parseFloat(this.min_money)){
