...
<div id="container">
    ...
    <div class="tuiguang" v-if="tui.show">
        <div class="center">
            ...
            <div class="com" style="margin:10px;">
                <div class="comtext">
        ...
        methods: {
            ...
            tuiguang:function(e){
                if(e){
                    ...
                    this.tui.url = '<?php echo e(env("APP_URL")); ?>/card/details/'+e.id+'?key='+this.user_key;
                    this.tui.desc = e.sell_info;
                }else{
                    this.tui.img = this.sell_form.hzImg;
                    this.tui.bg_img = this.sell_form.hzBanner;
                    this.tui.url = '<?php echo e(env("APP_URL")); ?>/m/?key='+this.user_key;
            ...
            drawImage(){
                ...
                this.loadImg([
                    ...
                    let w = bgwidth/2 - 100;
                    ctx.drawImage(img2, w, bgHeight-260, 200, 200)
                    // 设置字体属性
                    ctx.font = "20px bold 黑体";
                    //设置颜色颜色
                    ctx.fillStyle = "#ffa500";
                    //绘制文字
                    ctx.fillText("长按保存 • 长按识别",bgwidth/2 - 90,bgHeight - 30);
                    ...
                    document.getElementById("qrcodeCanvas").append(compose_img)		
