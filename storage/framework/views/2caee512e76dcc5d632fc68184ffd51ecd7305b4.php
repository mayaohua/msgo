...
<head>
    ...
    <style>
        ...
        #container{
            padding-bottom: <?php echo $active == -1 ? '0' :'50px'; ?>;
        }
        .loading{
            height:100vh;
            width:100vw;
...
const replaceImgSrc = () => {
    ...
    rootpath = "<?php echo e(env('STATIC_DOMAIN')); ?>",
    root = "<?php echo e(env('APP_URL')); ?>";
    root_wx = "<?php echo e(env('APP_WX_URL')); ?>";
    console.log(root)
            ...
            swiperList: [
                {
					...
					src: "<?php echo e(URL::asset('images/ylmb.gif')); ?>"
				},
                {
					id: 2,
					url: 'http://www.baidu.com',
					src: "<?php echo e(URL::asset('images/20190916-134749-a406.gif')); ?>"
				},
            ],
        }
    },
