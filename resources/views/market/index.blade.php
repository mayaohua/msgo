    ...
    new Vue({
        ...
        created:function(){
            ...
            this.sell_bill_huafei = {
                ...
                url : '{{env("APP_WX_URL")}}/bill/?key='+this.user_key,
                sell_info:'三网通话费充值推广一次终身绑定收益',
            };
            this.sell_bill_flow = {
                sell_item_img : this.sell_form.hzImg,
                sell_banner_img : this.sell_form.hzBanner,
                url : '{{env("APP_WX_URL")}}/bill/flow/?key='+this.user_key,
                sell_info: '三网通流量充值推广一次终身绑定收益',
            };
            this.sell_bill_vip = {
                sell_item_img : this.sell_form.hzImg,
                sell_banner_img : this.sell_form.hzBanner,
                url : '{{env("APP_WX_URL")}}/bill/vip/?key='+this.user_key,
            ...
            tuiguang:function(e){
                if(e){
                    ...
                    if(e.url){
                        ...
                        this.tui.url = '{{env("APP_WX_URL")}}/card/details/'+e.id+'?key='+this.user_key;
                    }
                    this.tui.desc = e.sell_info;
                }else{
                    this.tui.img = this.sell_form.hzImg;
                    this.tui.bg_img = this.sell_form.hzBanner;
                    this.tui.url = '{{env("APP_WX_URL")}}/card/?key='+this.user_key;
