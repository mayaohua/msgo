        ...
        <el-card class="box-card">
            ...
            <el-card class="box-card" shadow="never" style="margin-bottom:20px;">
                ...
                <el-table :data="tableData.data" border style="width: 100%">
                    ...
                    <el-table-column prop="fail_msg" label="下单状态">
                        <template slot-scope="scope">
                            <el-tag :type="scope.row.fail_msg == '' ? 'success' : 'warning'" disable-transitions>
                                @{{ scope.row.fail_msg == '' ? '成功' : '失败' }}</el-tag>
                        </template>
                    </el-table-column>
                    <el-table-column prop="fail_msg" label="错误消息">
                    </el-table-column>
